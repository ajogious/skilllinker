      ...
      <header className="border-b border-slate-800 bg-slate-950/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-white tracking-tight text-lg">SkillLinker</span>
          </div>
          <div className="flex items-center gap-3">
            <Link href="/login" className="text-sm text-slate-400 hover:text-white transition-colors px-3 py-1.5">
              Sign In
            </Link>
            <Link href="/register" className="text-sm font-semibold bg-indigo-500 hover:bg-indigo-400 text-white px-4 py-2 rounded-lg transition-colors">
              Get Started
            </Link>
          </div>
        </div>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <ScrollReveal animation="zoom-in">
            <div className="inline-flex items-center gap-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full px-4 py-1.5 mb-6">
              ...
              <span className="text-sm text-indigo-300 font-medium">Nigeria&apos;s Trusted Trades Platform</span>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal animation="fade-up" delay="200ms">
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/register" className="px-7 py-3.5 rounded-xl bg-indigo-500 hover:bg-indigo-400 text-white font-semibold text-base transition-all shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40">
                Post a Job — It&apos;s Free
              </Link>
              <Link href="/register?role=TRADESMAN" className="px-7 py-3.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-semibold text-base border border-slate-700 hover:border-slate-600 transition-all">
                I&apos;m a Tradesman →
              </Link>
            </div>
      ...
      <section className="relative py-20 px-4 border-t border-slate-800/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-400">Find specialists across all skilled trades</p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {CATEGORIES.map((cat, i) => (
              ...
              >
                <Link
                  href="/register"
                  className="group bg-slate-900 hover:bg-slate-800 border border-slate-800 hover:border-indigo-500/40 rounded-2xl p-5 transition-all block"
                >
      ...
      <section className="relative py-20 px-4 border-t border-slate-800/50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-400">From posting to completion in four simple steps</p>
          </div>
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative z-10">
                    ...
                    <span className="text-xs font-bold text-indigo-500 mb-1 block">{step.step}</span>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <ScrollReveal animation="fade-left">
            <div className="bg-indigo-500/5 border border-indigo-500/20 rounded-2xl p-7">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Need Work Done?</h3>
              <p className="text-slate-400 text-sm mb-5 leading-relaxed">
                Post your job for free and get matched with verified tradesmen in minutes.
              </p>
              <Link href="/register" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-indigo-500 hover:bg-indigo-400 text-white font-semibold text-sm transition-all">
                Post a Job Free
          ...
          <ScrollReveal animation="fade-right">
            <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-2xl p-7">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Are You a Tradesman?</h3>
              <p className="text-slate-400 text-sm mb-5 leading-relaxed">
                Create your profile, get verified, and connect with clients looking for your skills.
              </p>
              <Link href="/register" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-white font-semibold text-sm transition-all">
                Join as Tradesman
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
      ...
      <footer className="border-t border-slate-800 py-8 px-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-white">SkillLinker</span>
          </div>
          <p className="text-xs text-slate-600">
            © {new Date().getFullYear()} SkillLinker. Built for Nigeria&apos;s skilled tradesmen.
          </p>
